    ...
    >
        @foreach($products as $product)
            ...
            <div
                ...
                class="border border-1 border-gray-200 rounded-md hover:border-pink-300 transition-colors bg-white"
            >
                ...
                <div class="flex justify-between py-3 px-4">
                    <button
                        ...
                        class="w-10 h-10 rounded-full border border-1 border-pink-300 flex items-center justify-center hover:bg-pink-300 hover:text-white active:bg-pink-500 transition-colors"
                        :class="isInWatchlist(id) ? 'bg-pink-300 text-white' : 'text-pink-300'"
                    >
                        <svg
