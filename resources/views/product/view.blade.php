  ...
  init() {
      this.activeImage = this.images.length > 0 ? this.images[0] : null
                    ...
                    <div class="flex">
                        <template x-for="image in images">
                            <a
                                ...
                                class="cursor-pointer w-[80px] h-[80px] border border-gray-300 hover:border-pink-300 flex items-center justify-center"
                                :class="{'border-pink-500': activeImage === image}"
                            >
            ...
            <div class="lg:col-span-2">
                ...
                <div class="flex items-center justify-between mb-5 py-4">
                    ...
                    <input
                        ...
                        value="1"
                        min="1"
                        class="w-32 focus:border-pink-500 hovefocus:outline-none rounded focus:outline-none focus:ring-0 "
                    />
                </div>
                <button
