...
>
    ...
    <!-- Responsive Menu -->
    <div
        class="block fixed z-10 top-0 bottom-0 height h-full w-[220px] transition-all bg-pink-300 md:hidden"
        ...
        <ul>
            ...
            @if (!Auth::guest())
                <li x-data="{open: false}" class="relative">
                    <a
                        @click="open = !open"
                        class="cursor-pointer flex justify-between items-center py-2 px-3 hover:bg-pink-400"
                    >
                    ...
                    >
                        ...
                        <li>
                            <a
                                ...
                                class="flex items-center px-3 py-2 hover:bg-pink-400"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="h-5 w-5 mr-2"
            ...
            @else
                <li>
                    <a
                        href="{{ route('login') }}"
                        class="flex items-center py-2 px-3 transition-colors hover:bg-pink-400"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-6 w-6 mr-2"
                ...
                <li class="px-3 py-3">
                    <a
                        href="{{ route('register') }}"
                        class="block text-center text-white bg-emerald-400 py-2 px-3 rounded shadow-md hover:bg-emerald-500 active:bg-emerald-600 transition-colors w-full"
                    >
                        Register now
                    </a>
                </li>
        ...
        <ul class="grid grid-flow-col items-center">
            ...
            @if (!Auth::guest())
                <li x-data="{open: false}" class="relative">
                    <a
                        @click="open = !open"
                        class="cursor-pointer flex items-center py-navbar-item px-navbar-item pr-5 hover:bg-pink-400"
                    >
              <span class="flex items-center">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                My Account
                    ...
                    <ul
                        ...
                        x-transition
                        x-cloak
                        class="absolute z-10 right-0 bg-pink-300 py-2 w-48"
                    >
                        <li>
                            <a
            ...
            @else
                <li>
                    <a
                        href="{{ route('login') }}"
                        class="flex items-center py-navbar-item px-navbar-item hover:bg-pink-400"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-5 w-5 mr-2"
                ...
                <li>
                    <a
                        href="{{ route('register') }}"
                        class="inline-flex items-center text-white bg-emerald-400 py-2 px-3 rounded shadow-md hover:bg-emerald-500 active:bg-emerald-600 transition-colors mx-5"
                    >
                        Register now
                    </a>
                </li>
