        ...
        <div class="flex justify-between border-b-2 pb-3">
            <div class="flex items-center">
                ...
                <select @change="getProducts(null)" v-model="perPage"
                        class="appearance-none relative block w-24 px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-pink-300 focus:border-pink-300
 focus:z-10 sm:text-sm">
            ...
            <div>
                <input v-model="search" @change="getProducts(null)"
                       class="appearance-none relative block w-48 px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-pink-300 focus:border-pink-300
 focus:z-10 sm:text-sm"
...
"
                        ...
                        'group flex w-full items-center rounded-md px-2 py-2 text-sm',
                                        ...
                                        >
                                            <PencilIcon
                                                :active="active"
                                                class="mr-2 h-5 w-5 text-pink-300"
                                                aria-hidden="true"
                                            />
                                            Edit
                                        </button>
        ...
        <div v-if="!products.loading" class="flex justify-between items-center mt-5">
            ...
            >
                ...
                <a
                    ...
                    :class="[
              link.active
                ? 'z-10 bg-pink-50 border-pink-300 text-pink-400'
